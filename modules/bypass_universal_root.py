def get_script():
    ...
    return """
      ...
      function stackTraceHere(isLog){
          ...
          if(isLog){
              send({ action: 'log', message: stackinfo });
      ...
      /*function stackTraceNativeHere(isLog){
          ...
          send({ action: 'log', message: backtrace });
      }*/
      ...
      function bypassJavaFileCheck(){
          ...
          UnixFileSystem.checkAccess.implementation = function(file,access){
              ...
              if (filename.indexOf("magisk") >= 0) {
                  ...
                  send({ action: 'log', message: "Anti Root Detect - check file: " + filename });
                  return false;
              }
              ...
              onLeave:function(retval){
                  if(retval.toInt32() != 0){
                      if (commonPaths.indexOf(this.inputPath) >= 0) {
                          send({ action: 'log', message: "Anti Root Detect - fopen : " + this.inputPath });
              ...
              onLeave:function(retval){
                  if(retval.toInt32()==0){
                      if(commonPaths.indexOf(this.inputPath) >= 0){
                          ...
                          send({ action: 'log', message: "Anti Root Detect - access : " + this.inputPath });
      ...
      function bypassRootAppCheck(){
          ...
          ApplicationPackageManager.getPackageInfo.overload('java.lang.String', 'int').implementation = function(str,i){
              ...
              if (ROOTmanagementApp.indexOf(str) >= 0) {
                  send({ action: 'log', message: "Anti Root Detect - check package : " + str });
      ...
      function bypassShellCheck(){
          ...
          ProcessImpl.start.implementation = function(cmdarray,env,dir,redirects,redirectErrorStream){
              ...
              if(cmdarray[0] == "mount"){
                  ...
                  send({ action: 'log', message: "Anti Root Detect - Shell : " + cmdarray.toString() });
